  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-4 py-2 flex items-center justify-between border-b border-border bg-card">
        <span className="text-xs font-semibold text-muted-foreground tracking-wider uppercase">永續合約</span>
              ...
              return (
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground mt-0.5 font-mono">永續 · 量: {Math.floor(ticker.vol24h).toLocaleString()}</span>
                  </div>
